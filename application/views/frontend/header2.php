...
<head>
	...
	<title><?= $title?></title>
	<link rel="icon" type="image/x-icon" href="<?= base_url()?>assets/img/surat1.png" />
...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-purple fixed-top" id="mainNav">
		<div class="container">
			<a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="<?= base_url()?>assets/img/surat1.png"
					alt="darmawanita" /></a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav text-uppercase ml-auto">
					...
					<li class="nav-item"><a class="nav-link js-scroll-trigger" href="<?= base_url('home/#struktur')?>">New Informations</a>
					</li>
